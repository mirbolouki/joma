...
- **🗂 برگهٔ تصمیم گزارش مقایسهٔ `my` × `test` (۶ تصمیم + پاسخ آماده):** [`docs/handoff/33-comparison-decision-sheet.md`](docs/handoff/33-comparison-decision-sheet.md)
- **📦 v10 رسید (دور ۳۵) — تجمعی از v8:** C5 · کد دعوت · F1/F2/F3 — **تست ۸ موردی + چهار پاسخ:** [`docs/handoff/32-round-35-v10-status.md`](docs/handoff/32-round-35-v10-status.md)
- **🔍 روش مقایسهٔ دو ساب‌دامین (`my` × `test`) + پرامپت و چک‌لیست cPanel:** [`docs/handoff/31-two-subdomain-comparison-method.md`](docs/handoff/31-two-subdomain-comparison-method.md)
- **📨 پرامپت یک‌تکهٔ v10 (تجمعی از v8 + C5 + F1..F3 + جواب همهٔ سؤال‌ها):** [`docs/handoff/30-agent-prompt-v10.md`](docs/handoff/30-agent-prompt-v10.md)
- **👁 C5 — «وضعیت در یک نگاه» در کارت مراجع (قفل `L33`):** بند `C5` در [`docs/handoff/28-lock-policy-and-round-31-order.md`](docs/handoff/28-lock-policy-and-round-31-order.md)
- **📦 v9 رسید (دور ۳۲) — قفل اجرا شد:** C1 تب‌ها · C2 نقش‌ها · C3 داشبورد مشاور · C4 کارت دعوت — **تست ۷ موردی + پاسخ سه سؤال:** [`docs/handoff/29-round-32-v9-status.md`](docs/handoff/29-round-32-v9-status.md)
- **🔒 سیاست قفل + سفارش دور ۳۱ (تب‌ها · نقش‌ها · داشبورد مشاور):** [`docs/handoff/28-lock-policy-and-round-31-order.md`](docs/handoff/28-lock-policy-and-round-31-order.md)
