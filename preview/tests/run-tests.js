...
['MYT-001','Structure only','کد دعوت','پنج قلم اثبات','دیتابیس مشترک'].forEach(k => { if (doc('docs/handoff/31-two-subdomain-comparison-method.md').indexOf(k) < 0) bad('۳۴: «' + k + '» در سند مقایسه نیست'); });
