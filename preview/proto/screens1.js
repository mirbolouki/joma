...
/* ---------- وضعیت واقعی مسیر بازیابی رمز (دور ۲۱) ----------
   بک‌اند فرم «نام کاربری + رمز تازه» را بست، چون بدون کد یک‌بارمصرف امن نبود.
   این بنر در همهٔ گام‌ها نشان داده می‌شود تا کاربر و بازبین بدانند امروز چه چیزی واقعی است. */
function forgotStatus(){
  return '<div class="banner warn tiny" style="margin-bottom:12px">'+ic('i-info')+
    '<span><b>روی تست: این مسیر موقتاً بسته است.</b> فرم «نام کاربری + رمز تازه» امن نبود (بدون کد یک‌بارمصرف)، '+
    'پس بک‌اند بستش. راه امروز: <b>پیام به پشتیبانی</b> — <span dir="ltr">۰۹۹۶۷۹۷۹۴۷۱</span>.<br>'+
    'گام‌های زیر، <b>طراحی برای بعد از ساخته‌شدن کد</b> است: کد ۶ رقمی · ۱۵ دقیقه · ۵ تلاش · باطل‌شدن نشست‌های دیگر.</span></div>';
}
